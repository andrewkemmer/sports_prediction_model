...
FEATURE_MANIFEST = {
    ...
    "is_precip": {
        ...
        "point_in_time_rule": "weather_time_utc < kickoff_utc; forecast rows additionally require fetched_at_utc < kickoff_utc",
        "missing_value_policy": "NaN when no strictly-prior hourly precipitation value exists; never inferred from a daily archive or schedule payload",
        "representation": "game-level flag (all model families)",
        "model_family_availability": ["linear", "tree", "mlp"],
        "feature_version": 6,
    },
    "is_snow": {
        ...
        "point_in_time_rule": "weather_time_utc < kickoff_utc; forecast rows additionally require fetched_at_utc < kickoff_utc",
        "missing_value_policy": "NaN when no strictly-prior hourly snowfall value exists; never inferred from a daily archive or schedule payload",
        "representation": "game-level flag (all model families)",
        "model_family_availability": ["linear", "tree", "mlp"],
        "feature_version": 6,
    },
    "inj_qb_out_diff": {
        "description": "Home minus away QBs ruled Out before kickoff",
        "definition": "count of QBs whose latest report_status == 'Out' with date_modified strictly before kickoff, home minus away",
        "source": "nflverse timestamped injury reports (load_injuries)",
        "lookback": "latest admissible report per player",
        "aggregation": "timestamp-gated pre-kickoff player status count",
        "point_in_time_rule": "date_modified < kickoff; the latest admissible row per player wins",
        "missing_value_policy": "NaN when either team has no parseable pre-kickoff report snapshot; never fabricated",
        "representation": "difference (all model families)",
        "model_family_availability": ["linear", "tree", "mlp"],
        "feature_version": 5,
    },
    "inj_tackle_out_diff": {
        "description": "Home minus away tackles ruled Out before kickoff",
        "definition": "count of T/OT/LT/RT whose latest report_status == 'Out' with date_modified strictly before kickoff, home minus away",
        "source": "nflverse timestamped injury reports (load_injuries)",
        "lookback": "latest admissible report per player",
        "aggregation": "timestamp-gated pre-kickoff player status count",
        "point_in_time_rule": "date_modified < kickoff; the latest admissible row per player wins",
    ...
    "inj_edge_out_diff": {
        "description": "Home minus away edge rushers ruled Out before kickoff",
        "definition": "count of EDGE/DE/OLB/OL whose latest report_status == 'Out' with date_modified strictly before kickoff, home minus away",
        "source": "nflverse timestamped injury reports (load_injuries)",
        "lookback": "latest admissible report per player",
        "aggregation": "timestamp-gated pre-kickoff player status count",
        "point_in_time_rule": "date_modified < kickoff; the latest admissible row per player wins",
    ...
    "inj_starters_out_diff": {
        "description": "Home minus away players ruled Out before kickoff",
        "definition": "count of ALL players whose latest report_status == 'Out' with date_modified strictly before kickoff, home minus away",
        "source": "nflverse timestamped injury reports (load_injuries)",
        "lookback": "latest admissible report per player",
        "aggregation": "timestamp-gated pre-kickoff player status count",
        "point_in_time_rule": "date_modified < kickoff; the latest admissible row per player wins",
