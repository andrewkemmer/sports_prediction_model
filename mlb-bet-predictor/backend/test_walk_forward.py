    ...
    for d in range(n_days):
        ...
        for g in range(games_per_day):
            rows.append({
                ...
                "sp_era_30g_home": 3.5 + rng.normal(0, 0.5),
                "sp_era_30g_away": 3.5 + rng.normal(0, 0.5),
                "sp_k9_30g_home": 9.0 + rng.normal(0, 1),
                "sp_k9_30g_away": 9.0 + rng.normal(0, 1),
